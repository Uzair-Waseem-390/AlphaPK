    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-neutral-500 mt-1">Products marked as lost, damaged, or missing for a selected date or date range</p>
            </div>
                ...
                <>
                    {stats && (
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <Card className="p-4">
                                <p className="text-sm text-neutral-500">Total Lost Items</p>
                                <p className="text-2xl font-bold text-neutral-900">{stats.total_lost_items}</p>
                            </Card>
                            <Card className="p-4">
                                <p className="text-sm text-neutral-500">Total Lost Value (PKR)</p>
                                <p className="text-2xl font-bold text-error-600">
                                    {Number(stats.total_lost_cash || 0).toFixed(2)}
                                </p>
                            </Card>
                        </div>
                    )}
