...
class InvestorAdmin(AuditAdminMixin, admin.ModelAdmin):
    list_display  = ["name", "total_invested", "total_withdrawn", "net_stake", "is_deleted"]
    list_filter   = ["is_deleted"]
    search_fields = ["name", "email", "contact_number"]
    readonly_fields = AuditAdminMixin.readonly_fields + ("total_invested", "total_withdrawn", "net_stake")
